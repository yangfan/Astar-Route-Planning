...
int main(int argc, const char **argv) {
  ...
  std::cout << "Please input the start_x: \n";
  std::cin >> start_x;
  std::cout << "Please input the start_y: \n";
  std::cin >> start_y;
  std::cout << "Please input the end_x: \n";
  std::cin >> end_x;
  std::cout << "Please input the end_y: \n";
  std::cin >> end_y;
